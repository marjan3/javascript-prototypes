...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! C:\Users\mtanevski\Games\phaser-game0\src\main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _phaser = __webpack_require__(/*! phaser */ 299);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  function Game() {
	    ...
	    var width = document.documentElement.clientWidth > 800 ? 800 : document.documentElement.clientWidth;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Mushroom = __webpack_require__(/*! ../sprites/Mushroom */ 306);

	var _Mushroom2 = _interopRequireDefault(_Mushroom);

	var _Star = __webpack_require__(/*! ../sprites/Star */ 311);

	var _Star2 = _interopRequireDefault(_Star);

	var _Sky = __webpack_require__(/*! ../sprites/Sky */ 312);

	var _Sky2 = _interopRequireDefault(_Sky);

	var _Player = __webpack_require__(/*! ../sprites/Player */ 313);

	var _Player2 = _interopRequireDefault(_Player);

	var _FirstAid = __webpack_require__(/*! ../sprites/FirstAid */ 315);

	var _FirstAid2 = _interopRequireDefault(_FirstAid);

	var _Info = __webpack_require__(/*! ../text/Info */ 316);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.score = 0;
	      this.infoText = new _Info2.default({
	      ...
	      this.firstaid = new _FirstAid2.default({
	        game: this.game,
	        x: 10,
	        y: 0,
	        asset: 'firstaid'
	      ...
	      //  Here we'll create 12 of them evenly spaced apart
	      for (var _i = 5; _i < 11; _i++) {
	        //  Create a star inside of the 'stars' group
	        var diamond = this.newDiamond(_i);
	    ...
	    key: 'consumeFirstAid',
	    value: function consumeFirstAid(player, firstaid) {
	    ...
	    key: 'newStar',
	    value: function newStar(i) {
	      return new _Star2.default({
	        game: this.game,
	        x: i * 90,
	        y: 0,
	        asset: 'star'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Star = function (_Phaser$Sprite) {
	   ...
	   function Star(_ref) {
	      ...
	      var _this = _possibleConstructorReturn(this, (Star.__proto__ || Object.getPrototypeOf(Star)).call(this, game, x, y, asset));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Text) {
	  ...
	  function _class(_ref) {
	    ...
	    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, text, fontStyle));
